...
// Нет STW (stop-the-world) — перенос растянут по времени</code></pre>
          ...
          <details class="deep" style="margin:10px 0">
            ...
            <div class="deep-body">
              ...
              <p class="tight" style="color:var(--text-dim);font-size:12px">Структура: <code class="inline">Map</code> → <code class="inline">Directory</code> → <code class="inline">Table[]</code> → <code class="inline">Group[]</code> → 8 слотов + control word. Extendible hashing: старшие <code class="inline">globalDepth</code> бит хеша выбирают таблицу из directory. Цифры: микробенчмарки до +60%, реальные приложения ~+1.5% geometric mean CPU (<a href="https://go.dev/blog/swisstable" target="_blank" style="color:inherit;opacity:.6">go.dev/blog/swisstable</a>).</p>
